              ...
              <tr role="row">
              {
                this._l(columns, (column, cellIndex) =>
                  <th
                    ...
                    <div class={ ['cell', column.filteredValue && column.filteredValue.length > 0 ? 'highlight' : '', column.labelClassName] } on-click={ ($event) => this.handleSortClick($event, column) }
                    title={column.label}
                    >
                    {
                      column.renderHeader
                    ...
                    }
                    {
                      column.sortable && column.order
                        ...
                        <i class= { column.order === 'descending' ? 'sort-caret icon-ng-down' : 'sort-caret icon-ng-up' } on-click={ ($event) => this.handleSortClick($event, column) }></i>
                          </span>
                        : ''
                    }
                    {
