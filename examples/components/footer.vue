  ...
  <footer class="footer">
    <div class="container">
      <div class="footer-main">
        ...
        <a href="https://github.com/NicolasDevil/webapp-olm-pagecomponents" class="footer-main-link" target="_blank">{{ langConfig.repo }}</a>
        <a href="https://github.com/NicolasDevil/webapp-olm-pagecomponents/releases" class="footer-main-link" target="_blank">{{ langConfig.changelog }}</a>
        <a href="https://github.com/NicolasDevil/webapp-olm-pagecomponents/issues" class="footer-main-link" target="_blank">{{ langConfig.faq }}</a>
